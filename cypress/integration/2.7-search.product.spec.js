...
describe('Search product scenarios', () => {
  ...
  it(`${prefix} - Open storefront and search product`, updateRetry(3), () => {
    cy.searchProduct(productName)
  })

  it(
    `${prefix} - Verify product and articles are displaying`,
    updateRetry(3),
    () => {
  ...
  it(
    `${prefix} - Using pagination and opening articles`,
    updateRetry(3),
    () => {
  ...
  it(`${prefix} - Validate breadcrumbs`, updateRetry(3), () => {
  ...
  it(`${prefix} - Verify slug in pagination`, updateRetry(3), () => {
